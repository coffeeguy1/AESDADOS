...
import listasSingularmenteEncadeadas.Ex22.NodeSE;
...
public class Ex23 {
	...
	public static void main(String[] args) {
		...
		while(sair != 3)
		{
			...
			if(choose == 1)
			{
				valorCalda = Integer.parseInt(JOptionPane.showInputDialog("Qual o valor da calda?"));
				lista.putTail(valorCalda);
				System.out.println("Tamanho da lista: " + lista.size() + " Lista: " + lista);
			}
			
			else if(choose == 2) {
				JOptionPane.showMessageDialog(null, "Tamanho da lista: " + lista.size() + " Lista: " + lista);
			}
			else if(choose == 3)
			{
